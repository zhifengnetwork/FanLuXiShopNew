...
class Cart extends MobileBase {
    ...
    public function cart3(){
        ...
        try {
            ...
            $pay->setUserId($this->user_id)->setShopById($shop_id)->delivery($address['district'])->orderPromotion()->getAuction()->getUserSign()->useCouponById($coupon_id)->useUserMoney($user_money)->usePayPoints($pay_points,false,'mobile');
            // 提交订单
